// cross-ref: interacts with editor/core/{ColorConfig, EditorConfig}; editor/model/{SongDocument}; editor/widgets/{KeyboardLayout, Piano}; synth/{SynthConfig}
...
import { KeyboardLayout } from "../widgets/KeyboardLayout";
