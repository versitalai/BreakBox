// cross-ref: interacts with editor/core/{ArrayBufferWriter, ColorConfig, EditorConfig, Midi}; editor/model/{SongDocument}; synth/{SynthConfig, synth}
...
import { ArrayBufferWriter } from "../core/ArrayBufferWriter";
import { MidiChunkType, MidiFileFormat, MidiControlEventMessage, MidiEventType, MidiMetaEventMessage, MidiRegisteredParameterNumberMSB, MidiRegisteredParameterNumberLSB, volumeMultToMidiVolume, volumeMultToMidiExpression, defaultMidiPitchBend, defaultMidiExpression } from "../core/Midi";
