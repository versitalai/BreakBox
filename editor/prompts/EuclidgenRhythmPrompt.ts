// cross-ref: interacts with editor/core/{Change, ColorConfig, EditorConfig, changes}; editor/model/{SongDocument}; synth/{SynthConfig, synth}
...
import { ChangeEnsurePatternExists, ChangePatternNumbers, ChangeNoteAdded, ChangeInsertBars } from "../core/changes";
