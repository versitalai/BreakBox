// cross-ref: interacts with editor/core/{changes}; editor/model/{SongDocument}; editor/widgets/{SongEditor}; synth/{synth}
...
import { ChangePasteInstrument, ChangeAppendInstrument, ChangeViewInstrument } from "../core/changes";
