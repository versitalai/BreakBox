// cross-ref: interacts with editor/core/{Change, ColorConfig, changes}; editor/model/{SongDocument}; editor/widgets/{SongEditor}; synth/{SynthConfig, synth}
...
import { ChangeChipWaveLoopMode, ChangeChipWaveStartOffset, ChangeChipWaveLoopStart, ChangeChipWaveLoopEnd, ChangeChipWavePlayBackwards } from "../core/changes";
