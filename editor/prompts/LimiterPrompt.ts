// cross-ref: interacts with editor/core/{ColorConfig, EditorConfig, changes}; editor/model/{SongDocument}; editor/widgets/{SongEditor}
...
import { ChangeLimiterSettings } from "../core/changes";
