// cross-ref: interacts with editor/core/{Change, changes}; editor/model/{SongDocument}; synth/{SynthConfig}
...
import { ChangePatternsPerChannel, ChangeInstrumentsFlags, ChangeChannelCount } from "../core/changes";
