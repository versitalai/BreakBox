// cross-ref: interacts with editor/core/{Change, ColorConfig, EditorConfig, changes}; editor/model/{SongDocument}; editor/prompts/{Prompt}; synth/{SynthConfig, synth}
...
import { ChangeSpectrum } from "../core/changes";
