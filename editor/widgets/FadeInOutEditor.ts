// cross-ref: interacts with editor/core/{Change, ColorConfig, changes}; editor/model/{SongDocument}; synth/{SynthConfig, synth}
...
import { ChangeFadeInOut } from "../core/changes";
