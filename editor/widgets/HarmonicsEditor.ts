// cross-ref: interacts with editor/core/{ColorConfig, EditorConfig, changes}; editor/model/{SongDocument}; editor/prompts/{Prompt}; synth/{SynthConfig, synth}
...
import { ChangeHarmonics } from "../core/changes";
