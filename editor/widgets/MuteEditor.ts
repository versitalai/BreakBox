// cross-ref: interacts with editor/core/{ColorConfig, HTMLWrapper, changes}; editor/model/{SongDocument}; synth/{SynthConfig}
...
import { InputBox } from "../core/HTMLWrapper";
import { ChangeChannelOrder, ChangeChannelName, ChangeRemoveChannel } from "../core/changes";
