// cross-ref: interacts with editor/core/{Change, ColorConfig, EditorConfig, HTMLWrapper, Layout, Preferences, changes}; editor/model/{SongDocument}; editor/prompts/{AddSamplesPrompt, BeatsPerBarPrompt, ChannelSettingsPrompt, CustomChipPrompt, CustomFilterPrompt, CustomScalePrompt, CustomThemePrompt, EuclidgenRhythmPrompt, ExportPrompt, ImportPrompt, InstrumentExportPrompt, InstrumentImportPrompt, LayoutPrompt, LimiterPrompt, MoveNotesSidewaysPrompt, Prompt, RecordingSetupPrompt, SampleLoadingStatusPrompt, ShortenerConfigPrompt, SongDurationPrompt, SongRecoveryPrompt, SustainPrompt, ThemePrompt, TipPrompt, VisualLoopControlsPrompt}; global/{Oscilloscope}; synth/{SynthConfig, synth}
...
import { ColorConfig, ChannelColors } from "../core/ColorConfig";
...
import { EditorConfig, isMobile, prettyNumber, Preset, PresetCategory } from "../core/EditorConfig";
...
import { InputBox, Slider } from "../core/HTMLWrapper";
...
export class SongEditor {
    ...
    */
    ...
    constructor(/*private _doc: SongDocument*/) {
        ...
        this._samplePitchLockBox.addEventListener("input", () => { this.doc.record(new ChangeSamplePitchLock(this.doc, !this._samplePitchLockBox.checked, this._samplePitchLockBox.checked)) });
    ...
    public whenUpdated = (): void => {
        ...
        if (!this.doc.song.getChannelIsMod(this.doc.channel)) {
            ...
            // BreakBox: sample pitch lock — only meaningful for sampled chip instruments.
            const isSampledChip: boolean = instrument.type == InstrumentType.chip && ((Config.chipWaves[instrument.chipWave!].isSampled ?? false) || (Config.chipWaves[instrument.chipWave!].isCustomSampled ?? false));
            if (isSampledChip) {
                this._samplePitchLockRow.style.display = "";
