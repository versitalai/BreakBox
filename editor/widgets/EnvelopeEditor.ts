// cross-ref: interacts with editor/core/{Change, EditorConfig, HTMLWrapper, changes}; editor/model/{SongDocument}; synth/{SynthConfig, synth}
...
import { Slider } from "../core/HTMLWrapper";
