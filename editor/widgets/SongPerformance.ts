// cross-ref: interacts with editor/core/{Change, changes}; editor/model/{SongDocument}; synth/{SynthConfig, synth}
...
import { ChangeChannelBar, ChangePinTime, ChangeEnsurePatternExists, ChangeNoteAdded, ChangeInsertBars, ChangeDeleteBars, ChangeNoteLength } from "../core/changes";
